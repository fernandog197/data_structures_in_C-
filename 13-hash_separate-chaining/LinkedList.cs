    ...
    class LinkedList
    {
        ...
        public void Transversa ()
        {
            ...
            while(this.actualNodo.Next != null)
            {
                ...
                string d = this.actualNodo.Data;
                int k = this.actualNodo.Key;
        ...
        public void Add (int key, string v)
        {
            ...
            //Una vez actualNodo esta asignado al ultimo Nodo de nuestra list, creamos una nueva instancia de Nodo, le asignamos el valor
        ...
        public Nodo SearchValue (int key)
        {
        ...
        public Nodo PreviousNodo (int v)
        {
            ...
            */
            while(this.actualNodo.Key != null && this.actualNodo.Next.Key != v)
            {
                this.actualNodo = this.actualNodo.Next;
            }
        ...
        por parametro.
        */
        public void InsertNodo (int nodoValue, string newValue)
        {
        ...
        public Nodo SearchByIndex (int i)
        {
            //Chequeamos si la LinkedList esta vacia
            if(IsEmpty() == null)
            {
